...
#   # - STEP 7 - CASE 7 - No further development because IDE Visual Studio and Python Project with Docker 
#   # - STEP 8 - CASE 8 - START SERVER ON LOCALHOST:8088 AND RETURN FROM DATABASE MAX TIME FOR EACH MATRICULA
#    
